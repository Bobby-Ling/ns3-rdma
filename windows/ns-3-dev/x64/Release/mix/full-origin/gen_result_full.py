...
parser.add_argument('--config', type=str, default=f'{file_dir/'config.txt'}', help='Path to the configuration file')
...
print(f'Total Data: {total_data:.2f} Gbits')
